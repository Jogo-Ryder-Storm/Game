...
class Menu():
    def __init__(self):
        ...
        self.btn_play = Button("white", (WIDTH/2) - 125, 320, "Jogar", self.next_scene)
        self.btn_options = Button("white", (WIDTH/2) - 125, 400, "Opções", self.scene_options)
        self.btn_comandos = Button("white", (WIDTH/2) - 125, 480, "Sobre", self.comandos)
